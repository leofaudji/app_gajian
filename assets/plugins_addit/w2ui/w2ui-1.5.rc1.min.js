    ...
    w2utils = function(a) {
        ...
        function p(a, b, c) {
            ...
            var d = {
                ...
                useGrouping: c ==','? true : c
            };
            if (b == null || b < 0) {
                d.minimumFractionDigits = 0;
                d.maximumFractionDigits = 20;
            }
            return parseFloat(a).toLocaleString(w2utils.settings.locale, d);
        }
        ...
        function r(a, b) {
            ...
            var e = "am",
                ...
                h = c.getMinutes(),
                i = c.getSeconds();
            return h < 10 && (h = "0" + h), i < 10 && (i = "0" + i), b.indexOf("am") === -1 && b.indexOf("pm") === -1 || (f >= 12 && (e = "pm"), f > 12 && (f -= 12)), b.toLowerCase().replace("am", e).replace("pm", e).replace("hhh", f < 10 ? "0" + f : f).replace("hh24", g < 10 ? "0" + g : g).replace("h24", g).replace("hh", f).replace("mm", h).replace("mi", h).replace("ss", i).replace(/(^|[^a-z$])h/g, "$1" + f).replace(/(^|[^a-z$])m/g, "$1" + h).replace(/(^|[^a-z$])s/g, "$1" + i)
        }

        function s(a, b) {
            var c;
            return "" === a || null == a || "object" == typeof a && !a.getMonth ? "" : ("string" != typeof b ? c = [this.settings.dateFormat, this.settings.timeFormat] : (c = b.split("|"), c[0] = c[0].trim(), c[1] = c[1].trim()), "h12" == c[1] && (c[1] = "h:m pm"), "h24" == c[1] && (c[1] = "h24:m"), this.formatDate(a, c[0]) + " " + this.formatTime(a, c[1]))
        }
        ...
        function F(b, c) {
            var d, e = '<div id="_tmp_width" style="position: absolute; top: -900px;' + (c || "") + '">' + u(b) + "</div>";
        ...
        function H(b) {
            return b || (b = "en-us"), "string" != typeof b ? void(w2utils.settings = a.extend(!0, w2utils.settings, b)) : (5 === b.length && (b = "locale/" + b + ".json"), w2utils.settings.phrases = {}, void a.ajax({
                ...
                success: function(b, c, d) {
                    w2utils.settings = a.extend(!0, w2utils.settings, b)
                },
        ...
        function I() {
            if (Q.scrollBarSize) return Q.scrollBarSize;
            ...
            return a("body").append(b), Q.scrollBarSize = 100 - a("#_scrollbar_width > div").width(), a("#_scrollbar_width").remove(), String(navigator.userAgent).indexOf("MSIE") >= 0 && (Q.scrollBarSize = Q.scrollBarSize / 2), Q.scrollBarSize
        }
        ...
        var Q = {},
            R = {
                ...
                testLocalStorage: P,
                hasLocalStorage: P(),
                isIOS: navigator.userAgent.toLowerCase().indexOf("iphone") != -1 || navigator.userAgent.toLowerCase().indexOf("ipod") != -1 || navigator.userAgent.toLowerCase().indexOf("ipad") != -1,
...
w2utils.formatters = {
        ...
        on: function(a, b) {
            ...
            return d.isPlainObject(a) || (a = {
                ...
                target: null,
                onComplete: null
            }, a), a.type ? b ? (d.isArray(this.handlers) || (this.handlers = []), console.log("add", a), void this.handlers.push({
                edata: a,
                handler: b
    ...
    function(a) {
        a.fn.w2render = function(b) {
            ...
            return 1 == arguments.length && "object" == typeof b && (c = b, null != c.html && (b = c.html)), c = a.extend({
                ...
                var d = a(c).data("options");
                null == d && (d = {}), a(a(c).data("taged-el")).removeClass(d.inputClass).removeData("w2tag").removeData("checkIfMoved"), clearInterval(a(c).data("timer")), a(c).remove()
            }) : a(this).each(function(d, e) {
                function f() {
                    j = a("#w2ui-tag-" + i), j.length <= 0 || (clearInterval(j.data("timer")), j.remove(), a(document).off(".w2tag"), a(e).off(".w2tag", f).removeClass(c.inputClass).removeData("w2tag").removeData("checkIfMoved"), a(e).length > 0 && (a(e)[0].style.cssText = k), "function" == typeof c.onHide && c.onHide())
                }

                function g(b, d) {
                    var h = a(e).offset();
                    if (0 === a(e).length || 0 === h.left && 0 === h.top || 0 === j.find(".w2ui-tag-body").length) return clearInterval(j.data("timer")), void f();
                    d || setTimeout(g, 100);
                    var i = "w2ui-tag-right",
                        k = parseInt(h.left + e.offsetWidth + (c.left ? c.left : 0)),
                        l = parseInt(h.top + (c.top ? c.top : 0)),
                        m = j.find(".w2ui-tag-body"),
                        n = m[0].offsetWidth,
                        o = m[0].offsetHeight;
                    if ("string" == typeof c.position && c.position.indexOf("|") != -1 && (c.position = c.position.split("|")), "top" == c.position) i = "w2ui-tag-top", k = parseInt(h.left + (c.left ? c.left : 0)) - 14, l = parseInt(h.top + (c.top ? c.top : 0)) - o - 10;
                    else if ("bottom" == c.position) i = "w2ui-tag-bottom", k = parseInt(h.left + (c.left ? c.left : 0)) - 14, l = parseInt(h.top + e.offsetHeight + (c.top ? c.top : 0)) + 10;
                    else if ("left" == c.position) i = "w2ui-tag-left", k = parseInt(h.left + (c.left ? c.left : 0)) - n - 20, l = parseInt(h.top + (c.top ? c.top : 0));
                    else if (Array.isArray(c.position)) {
                        for (var p = window.innerWidth, q = window.innerHeight, r = 0; r < c.position.length; r++) {
                            var s = c.position[r];
                            if ("right" == s) {
                                if (i = "w2ui-tag-right", k = parseInt(h.left + e.offsetWidth + (c.left ? c.left : 0)), l = parseInt(h.top + (c.top ? c.top : 0)), k + n <= p) break
                            } else if ("left" == s) {
                                if (i = "w2ui-tag-left", k = parseInt(h.left + (c.left ? c.left : 0)) - n - 20, l = parseInt(h.top + (c.top ? c.top : 0)), k >= 0) break
                            } else if ("top" == s) {
                                if (i = "w2ui-tag-top", k = parseInt(h.left + (c.left ? c.left : 0)) - 14, l = parseInt(h.top + (c.top ? c.top : 0)) - o - 10, k + n <= p && l >= 0) break
                            } else if ("bottom" == s && (i = "w2ui-tag-bottom", k = parseInt(h.left + (c.left ? c.left : 0)) - 14, l = parseInt(h.top + e.offsetHeight + (c.top ? c.top : 0)) + 10, k + n <= p && l + o <= q)) break
                        }
                        m.data("posClass") !== i && m.removeClass("w2ui-tag-right w2ui-tag-left w2ui-tag-top w2ui-tag-bottom").addClass(i).data("posClass", i)
                    }
                    return j.data("position") !== k + "x" + l && b !== !0 && j.css(w2utils.cssPrefix({
                        transition: d ? "0s" : ".2s"
                    })).css({
                        left: k + "px",
                        top: l + "px"
                ...
                var h = c.id ? c.id : e.id,
                    i = w2utils.escapeId(h),
                    j = a("#w2ui-tag-" + i);
                if ("" === b || null == b) return j.css("opacity", 0), clearInterval(j.data("timer")), void j.remove();
                if (0 !== j.length) c = a.extend(j.data("options"), c), j.data("options", c), j.find(".w2ui-tag-body").attr("style", c.style).addClass(c.className).html(c.html), g(!0);
                else {
                    var k = "";
                    a(e).length > 0 && (k = a(e)[0].style.cssText), a("body").append('<div onclick="event.stopPropagation()" style="display:none;" id="w2ui-tag-' + h + '"        class="w2ui-tag ' + (a(e).parents(".w2ui-popup, .w2ui-overlay-popup, .w2ui-message").length > 0 ? "w2ui-tag-popup" : "") + '">   <div style="margin: -2px 0px 0px -2px; white-space: nowrap;">      <div class="w2ui-tag-body ' + c.className + '" style="' + (c.style || "") + '">' + b + "</div>   </div></div>"), j = a("#w2ui-tag-" + i), a(e).data("w2tag", j.get(0)).data("checkIfMoved", g)
                }
                setTimeout(function() {
                    if (j.css("display", "block"), a(e).offset()) {
                        var b = g(!0);
                        null != b && (j.css({
                            opacity: "1",
                            left: b.left + "px",
                            top: b.top + "px"
                        }).data("options", c).data("taged-el", e).data("position", b.left + "x" + b.top).data("timer", setTimeout(g, 100)).find(".w2ui-tag-body").addClass(b.posClass), a(e).css(c.css).off(".w2tag").addClass(c.inputClass), c.hideOnKeyPress && a(e).on("keypress.w2tag", f), c.hideOnBlur && a(e).on("blur.w2tag", f), c.hideOnClick && a(document).on("click.w2tag", f), "function" == typeof c.onShow && c.onShow())
                    }
                }, 1)
            })
            ...
            function e(b) {
                if (!b || 0 === b.button) {
                    ...
                    var f;
                    "function" == typeof c.onHide && (f = c.onHide()), f !== !1 && (d.remove(), a(document).off("click", e), clearInterval(d.data("timer")))
                }
            }
            ...
            var n = a(g).offset() || {};
            return k.data("element", g.length > 0 ? g[0] : null).data("options", c).data("position", n.left + "x" + n.top).fadeIn("fast").on("click", function(a) {
                "LABEL" == a.target.tagName.toUpperCase() && a.stopPropagation()
            }).on("mousedown", function(b) {
                a("#w2ui-overlay" + h).data("keepOpen", !0), ["INPUT", "TEXTAREA", "SELECT"].indexOf(b.target.tagName.toUpperCase()) != -1 || c.selectable || b.preventDefault()
            }), k[0].hide = e, k[0].resize = f, setTimeout(function() {
                f(), a(document).off(".w2overlayHide").on("click.w2overlayHide", e), "function" == typeof c.onShow && c.onShow()
            }, 10), d(), a(this)
            ...
            function d() {
                setTimeout(function() {
                    ...
                    if (b.addClass("w2ui-selected"), c.tmp && (c.tmp.contentHeight = a("#w2ui-overlay" + i + " table").height() + (c.search ? 50 : 10)), c.tmp && (c.tmp.contentWidth = a("#w2ui-overlay" + i + " table").width()), a("#w2ui-overlay" + i).length > 0 && a("#w2ui-overlay" + i)[0].resize(), b.length > 0) {
            ...
            function f() {
                ...
                for (var a = 0, b = '<table cellspacing="0" cellpadding="0" class="w2ui-drop-menu"><tbody>', d = null, e = null, f = 0; f < c.items.length; f++) {
                    ...
                    if ("string" == typeof g ? g = {
                        ...
                        var h = "",
                            i = g.text;
                        if ("function" == typeof c.render && (i = c.render(g, c)), d && (h = '<td class="menu-icon"><div class="w2ui-tb-image w2ui-icon ' + d + '"></div></td>'), e && (h = '<td class="menu-icon" align="center"><span class="w2ui-icon ' + e + '"></span></td>'), null == i || "" === i || /^-+$/.test(i)) b += '<tr><td colspan="3" style="padding: 6px; pointer-events: none"><div style="border-top: 1px solid silver;"></div></td></tr>';
                        else {
            ...
            if ("refresh" === b)
                ...
                if ("refresh-index" !== b) {
                    1 === arguments.length ? c = b : c.items = b, "object" != typeof c && (c = {}), c = a.extend({}, g, c), a.fn.w2menuOptions = c, c.name && (i = "-" + c.name), "function" == typeof c.select && "function" != typeof c.onSelect && (c.onSelect = c.select), "function" == typeof c.onRender && "function" != typeof c.render && (c.render = c.onRender), a.fn.w2menuClick = function(b, d) {
                        var e = !1;
                        ["radio", "check"].indexOf(c.type) != -1 && (b.shiftKey || b.metaKey || b.ctrlKey) && (e = !0), "function" == typeof c.onSelect && setTimeout(function() {
                            c.onSelect({
                                index: d,
                                item: c.items[d],
                                keepOpen: e,
                        ...
                        f.removeData("keepOpen"), "function" != typeof f[0].hide || e || f[0].hide()
                    }, a.fn.w2menuDown = function(b, d) {
                        var e = a(b.target).parents("tr"),
                            f = e.find(".w2ui-icon");
                        if ("check" == c.type || "radio" == c.type) {
                            var g = c.items[d];
                            g.checked = !g.checked, g.checked ? ("radio" == c.type && f.parents("table").find(".w2ui-icon").removeClass("w2ui-icon-check").addClass("w2ui-icon-empty"), f.removeClass("w2ui-icon-empty").addClass("w2ui-icon-check")) : "check" == c.type && f.removeClass("w2ui-icon-check").addClass("w2ui-icon-empty")
                        }
            ...
            function d(a) {
                for (var b = (a.color, '<div class="w2ui-color" onmousedown="event.stopPropagation(); event.preventDefault()"><table cellspacing="5"><tbody>'), c = 0; c < g.length - 1; c++) {
                    b += "<tr>";
                    for (var d = 0; d < g[c].length; d++) b += '<td>    <div class="color ' + ("" === g[c][d] ? "no-color" : "") + '" style="background-color: #' + g[c][d] + ';"        name="' + g[c][d] + '" index="' + c + ":" + d + '">' + (a.color == g[c][d] ? "&#149;" : "&#160;") + "    </div></td>", a.color == g[c][d] && (f = [c, d]);
                    b += "</tr>", c < 2 && (b += '<tr><td style="height: 8px" colspan="8"></td></tr>')
                }
                var e = g[g.length - 1];
                return b += '<tr><td style="height: 8px" colspan="8"></td></tr><tr>   <td colspan="4" style="text-align: left"><input placeholder="#FFF000" style="margin-left: 1px; width: 74px" maxlength="7"/></td>   <td><div class="color" style="background-color: #' + e[0] + ';" name="' + e[0] + '" index="8:0">' + (a.color == e[0] ? "&#149;" : "&#160;") + '</div></td>   <td><div class="color" style="background-color: #' + e[1] + ';" name="' + e[1] + '" index="8:0">' + (a.color == e[1] ? "&#149;" : "&#160;") + '</div></td>   <td><div class="color" style="background-color: #' + e[2] + ';" name="' + e[2] + '" index="8:0">' + (a.color == e[2] ? "&#149;" : "&#160;") + '</div></td>   <td><div class="color" style="background-color: #' + e[3] + ';" name="' + e[3] + '" index="8:0">' + (a.color == e[3] ? "&#149;" : "&#160;") + '</div></td></tr><tr><td style="height: 4px" colspan="8"></td></tr>', b += "</tbody></table></div>"
            }
            var e = a(this)[0],
                f = [-1, -1];
            ...
            var g = a.fn.w2colorPalette;
            "string" == typeof b && (b = {
                color: b,
                transparent: !0
            }), b.transparent && "555555" == g[0][1] && (g[0].splice(1, 1), g[0].push("")), b.transparent || "555555" == g[0][1] || (g[0].splice(1, 0, "555555"), g[0].pop()), b.color && (b.color = String(b.color).toUpperCase()), 0 === a("#w2ui-overlay").length ? a(e).w2overlay(d(b), {
                onHide: function() {
                    "function" == typeof c && c(a(e).data("_color")), a(e).removeData("_color")
                }
            }) : a("#w2ui-overlay .w2ui-color").parent().html(d(b)), a("#w2ui-overlay .color").off(".w2color").on("mousedown.w2color", function(b) {
                var c = a(b.originalEvent.target).attr("name");
                f = a(b.originalEvent.target).attr("index").split(":"), a(e).data("_color", c)
            ...
            }).on("keyup.w2color", function(a) {
                "" !== this.value && "#" !== this.value[0] && (this.value = "#" + this.value)
            }).on("change.w2color", function(d) {
                var f = this.value;
                return "#" == f.substr(0, 1) && (f = f.substr(1)), 6 != f.length ? void a(this).w2tag("Invalid color.") : (a.fn.w2colorPalette[g.length - 1].unshift(f.toUpperCase()), a(e).w2color(b, c), void setTimeout(function() {
                    a("#w2ui-overlay input")[0].focus()
                }, 100))
            }).w2field("hex"), e.nav = function(b) {
                switch (b) {
                    case "up":
                        f[0]--;
                        break;
                ...
                return f[0] < 0 && (f[0] = 0), f[0] > g.length - 2 && (f[0] = g.length - 2), f[1] < 0 && (f[1] = 0), f[1] > g[0].length - 1 && (f[1] = g[0].length - 1), color = g[f[0]][f[1]], a(e).data("_color", color), color
            }
        }
    }(jQuery),
    function($) {
        var w2grid = function(a) {
            this.name = null, this.box = null, this.header = "", this.url = "", this.routeData = {}, this.columns = [], this.columnGroups = [], this.records = [], this.summary = [], this.searches = [], this.searchData = [], this.sortData = [], this.postData = {}, this.httpHeaders = {}, this.toolbar = {}, this.stateId = null, this.show = {
                ...
                skipRecords: !0,
                saveRestoreState: !0
            }, this.hasFocus = !1, this.autoLoad = !0, this.fixedBody = !0, this.recordHeight = 35, this.lineNumberWidth = null, this.vs_start = 150, this.vs_extra = 15, this.keyboard = !0, this.selectType = "row", this.multiSearch = !0, this.multiSelect = !0, this.multiSort = !0, this.reorderColumns = !1, this.reorderRows = !1, this.markSearch = !0, this.columnTooltip = "normal", this.disableCVS = !1, this.textSearch = "begins", this.total = 0, this.limit = 100, this.offset = 0, this.style = "", this.ranges = [], this.menu = [], this.method = null, this.recid = null, this.parser = null, this.last = {
                field: "",
                caption: "",
                logic: "OR",
                search: "",
        ...
        $.fn.w2grid = function(a) {
            if ($.isPlainObject(a)) {
                ...
                $.extend(k, {
                    ...
                    searchData: [],
                    handlers: []
                }), null != k.onExpand && (k.show.expandColumn = !0), $.extend(!0, k.toolbar, j);
                var l;
                if (b)
            ...
            get: function(a, b) {
                if ($.isArray(a)) {
                    for (var c = [], d = 0; d < this.records.length; d++) $.inArray(this.records[d].recid, a) != -1 && (b === !0 ? c.push(d) : c.push(this.records[d]));
                    for (var d = 0; d < this.summary.length; d++) $.inArray(this.summary[d].recid, a) != -1 && (b === !0 ? c.push(d) : c.push(this.summary[d]));
                    return c
                }
                for (var d = 0; d < this.records.length; d++)
                    if (this.records[d].recid == a) return b === !0 ? d : this.records[d];
                for (var d = 0; d < this.summary.length; d++)
                    if (this.summary[d].recid == a) return b === !0 ? d : this.summary[d];
                return null
            },
            remove: function() {
                for (var a = 0, b = 0; b < arguments.length; b++) {
                    for (var c = this.records.length - 1; c >= 0; c--) this.records[c].recid == arguments[b] && (this.records.splice(c, 1),
                        a++);
            ...
            localSort: function(a, b) {
                ...
                function g(a, b) {
                    ...
                    for (var c = 0; c < k.sortData.length; c++) {
                        ...
                        k.sortData[c].field_ && (d = k.sortData[c].field_);
                        var e = a[d],
                            f = b[d];
                        String(d).indexOf(".") != -1 && (e = k.parseField(a, d), f = k.parseField(b, d));
                        var g = k.getColumn(d);
                        g && null != g.editable && ($.isPlainObject(e) && e.text && (e = e.text), $.isPlainObject(f) && f.text && (f = f.text));
                        var i = h(e, f, c, k.sortData[c].direction);
                        if (0 !== i) return i
                    }
                    var i = h(a.recid, b.recid, -1, "asc");
                    return 0 !== i ? i : 0
                }
                ...
                function h(a, b, c, d) {
                    ...
                    if (null != a && "" !== a && (null == b || "" === b)) return -1;
                    var e = "asc" == d ? 1 : -1;
                    if (typeof a != typeof b) return typeof a > typeof b ? e : -e;
                    if (a.constructor.name != b.constructor.name) return a.constructor.name > b.constructor.name ? e : -e;
                    a && "object" == typeof a && (a = a.valueOf()), b && "object" == typeof b && (b = b.valueOf());
                    var f = {}.toString;
                    return a && "object" == typeof a && a.toString != f && (a = String(a)), b && "object" == typeof b && b.toString != f && (b = String(b)), "string" == typeof a && (a = $.trim(a.toLowerCase())), "string" == typeof b && (b = $.trim(b.toLowerCase())), a > b ? e : a < b ? -e : 0
                }
                    ...
                    for (var c = 0, d = 0; d < f.searchData.length; d++) {
                        ...
                        if (null != e) {
                            ...
                            switch (e.operator) {
                                ...
                                case "in":
                                    var m = e.value;
                                    e.svalue && (m = e.svalue), m.indexOf(w2utils.isFloat(j) ? parseFloat(j) : j) !== -1 && c++, m.indexOf(w2utils.isFloat(i) ? parseFloat(i) : i) !== -1 && c++;
                                    break;
                                case "not in":
                                    var m = e.value;
                                    e.svalue && (m = e.svalue), m.indexOf(w2utils.isFloat(j) ? parseFloat(j) : j) == -1 && c++, m.indexOf(w2utils.isFloat(i) ? parseFloat(i) : i) == -1 && c++;
                ...
                if (this.total = this.records.length, this.last.searchIds = [], this.prepareData(), this.searchData.length > 0 && !d) {
                    ...
                    for (var i = 0; i < this.records.length; i++) {
                        var j = this.records[i],
                            k = b(j);
                        k && (j && j.w2ui && c(j.w2ui.parent_recid), this.last.searchIds.push(i))
                    }
            ...
            refreshRanges: function() {
                function a(a) {
                    ...
                    }, $(document).off("mousemove", b).on("mousemove", b), $(document).off("mouseup", c).on("mouseup", c), a.preventDefault()
                }
                ...
                function c(a) {
                    d.removeRange("grid-selection-expand"), delete d.last.move, $(document).off("mousemove", b), $(document).off("mouseup", c), d.trigger($.extend(B, {
                        phase: "after"
                    }))
                }
            ...
            selectAll: function() {
                ...
                if (this.multiSelect !== !1) {
                    ...
                    if (b.isCancelled !== !0) {
                        ...
                        var d = this.getSelection();
                        return 1 == d.length ? this.toolbar.enable("w2ui-edit") : this.toolbar.disable("w2ui-edit"), d.length >= 1 ? this.toolbar.enable("w2ui-delete") : this.toolbar.disable("w2ui-delete"), this.addRange("selection"), $("#grid_" + this.name + "_check_all").prop("checked", !0), this.trigger($.extend(b, {
                            phase: "after"
                        })), (new Date).getTime() - a
                    }
                }
                ...
                if ("string" == typeof a && (1 == arguments.length && (b = a, a = "all"), g = a, h = b, e = !1, f = i ? "AND" : "OR", null != b))
                    if ("all" == a.toLowerCase())
                        if (this.searches.length > 0)
                            for (var j = 0; j < this.searches.length; j++) {
                                var k = this.searches[j];
                                if ("text" == k.type || "alphanumeric" == k.type && w2utils.isAlphaNumeric(b) || "int" == k.type && w2utils.isInt(b) || "float" == k.type && w2utils.isFloat(b) || "percent" == k.type && w2utils.isFloat(b) || ("hex" == k.type || "color" == k.type) && w2utils.isHex(b) || "currency" == k.type && w2utils.isMoney(b) || "money" == k.type && w2utils.isMoney(b) || "date" == k.type && w2utils.isDate(b) || "time" == k.type && w2utils.isTime(b) || "datetime" == k.type && w2utils.isDateTime(b) || "enum" == k.type && w2utils.isAlphaNumeric(b) || "list" == k.type && w2utils.isAlphaNumeric(b)) {
                                    var v = {
                                        field: k.field,
                                        type: k.type,
            ...
            searchOpen: function() {
                if (this.box && 0 !== this.searches.length) {
                    ...
                    return b.isCancelled === !0 ? void setTimeout(function() {
                        ...
                        onShow: function() {
                            ...
                            var c = $("#w2ui-overlay-" + this.name + "-searchOverlay .w2ui-grid-searches *[rel=search]");
                            c.length > 0 && c[0].focus(), a.trigger($.extend(b, {
                                phase: "after"
                            }))
                        }
                    })
            ...
            clear: function(a) {
                this.total = 0, this.records = [], this.summary = [], this.last.xhr_offset = 0, this.reset(!0), a || this.refresh()
            },
            reset: function(a) {
            ...
            request: function(a, b, c, d) {
                if (null == b && (b = {}), "" != c && null != c || (c = this.url), "" != c && null != c) {
                    ...
                    "HTTP" == w2utils.settings.dataType && (k.data = "object" == typeof k.data ? String($.param(k.data, !1)).replace(/%5B/g, "[").replace(/%5D/g, "]") : k.data), "HTTPJSON" == w2utils.settings.dataType && (k.data = {
                ...
                if ("error" != status) {
                    if (null != responseText && "" != responseText) {
                        ...
                        if ("error" == data.status) obj.error(data.message);
                            ...
                            if ("get" == cmd) {
                                if (null == data.total && (data.total = -1), data.records.length == this.limit ? this.last.xhr_hasMore = !0 : (this.last.xhr_hasMore = !1, this.total = this.last.xhr_offset + data.records.length), 0 === this.last.xhr_offset) this.records = [], this.summary = [], w2utils.isInt(data.total) && (this.total = parseInt(data.total));
            ...
            getChanges: function() {
                for (var a = [], b = 0; b < this.records.length; b++) {
                    var c = this.records[b];
                    c.w2ui && null != c.w2ui.changes && a.push($.extend(!0, {
                        recid: c.recid
                    }, c.w2ui.changes))
                }
                return a
            ...
            editField: function(a, b, c, d) {
                ...
                if (h) {
                    ...
                    if (l.isCancelled !== !0 && (c = l.value, this.selectNone(), this.select({
                            recid: a,
                            column: b
                        }), this.last.edit_col = b, ["checkbox", "check"].indexOf(h.type) == -1)) {
                        ...
                        setTimeout(function() {
                            n.find("input, select, div.w2ui-input").data("old_value", p).on("mousedown", function(a) {
                                a.stopPropagation()
                            }).on("click", function(a) {
                                ...
                                var a = n.find(".w2ui-input"),
                                    b = $(a).val().length;
                                "div" == h.type && (b = $(a).text().length), a.length > 0 && (a.focus(), clearTimeout(f.last.kbd_timer), "SELECT" != a[0].tagName && w2utils.setCursorPosition(a[0], b), a[0].resize = e, e.call(a[0], null))
            ...
            editChange: function(a, b, c, d) {
                ...
                for (null != $(d.target).data("old_value") && (n.value_previous = $(d.target).data("old_value"));;) {
                    if (k = n.value_new, "object" != typeof k && String(l) != String(k) || "object" == typeof k && k.id != l && ("object" != typeof l || null == l || k.id != l.id)) {
                ...
                var o = $(j).find("[col=" + c + "]");
                f || (h.w2ui && h.w2ui.changes && null != h.w2ui.changes[i.field] ? o.addClass("w2ui-changed") : o.removeClass("w2ui-changed"), o.replaceWith(this.getCellHTML(b, c, f))), $(this.box).find("div.w2ui-edit-box").remove(), this.show.toolbarSave && (this.getChanges().length > 0 ? this.toolbar.enable("w2ui-save") : this.toolbar.disable("w2ui-save"))
            },
            delete: function(a) {
                ...
                if (c.isCancelled !== !0) {
                    ...
                    if (0 !== d.length) {
                        if ("" != this.msgDelete && !a) return void this.message({
                            ...
                            buttons: '<button class="w2ui-btn w2ui-btn-red" onclick="w2ui[\'' + this.name + "'].delete(true)\">" + w2utils.lang("Yes") + '</button><button class="w2ui-btn" onclick="w2ui[\'' + this.name + "'].message()\">" + w2utils.lang("No") + "</button>",
                            onOpen: function(a) {
            ...
            click: function(a, b) {
                ...
                if (!(1 == this.last.cancelClick || b && b.altKey)) {
                    if ("object" == typeof a && (d = a.column, a = a.recid), null == b && (b = {}), c - parseInt(this.last.click_time) < 350 && this.last.click_recid == a && "click" == b.type) return void this.dblClick(a, b);
                    ...
                    if (h.isCancelled !== !0) {
                        ...
                        if (e.last.sel_ind = j, e.last.sel_col = d, e.last.sel_recid = a, e.last.sel_type = "click", b.shiftKey && i.length > 0 && e.multiSelect) {
                            ...
                            var u = this.last.selection,
                                ...
                                w = !1;
                            $(b.target).parents("td").hasClass("w2ui-col-select") && (w = !0), (b.ctrlKey || b.shiftKey || b.metaKey || w) && this.multiSelect || this.showSelectColumn ? ("row" != this.selectType && $.inArray(d, u.columns[j]) == -1 && (v = !1), v === !0 ? this.unselect({
                                recid: a,
                                column: d
                            }) : this.select({
                                recid: a,
                                column: d
                            })) : ("row" != this.selectType && $.inArray(d, u.columns[j]) == -1 && (v = !1), i.length > 300 ? this.selectNone() : this.unselect.apply(this, i), v === !0 && 1 == i.length ? this.unselect({
                                recid: a,
                                column: d
                            }) : this.select({
                                recid: a,
            ...
            columnClick: function(a, b) {
                ...
                if (c.isCancelled !== !0) {
                    ...
                    } else if ("line-number" == c.field) this.getSelection().length >= this.records.length ? this.selectNone() : this.selectAll();
                    else {
                        ...
                        switch (r) {
                            ...
                            case 13:
                                if ("row" == this.selectType && d.show.expandColumn === !0) {
                                    ...
                                    "row" == this.selectType && this.last.edit_col && (k = [this.last.edit_col]), k.length > 0 && (d.editField(j, k[0], null, a), q = !0)
                                }
                                break;
                            case 37:
                                if (g) {
                            ...
                            case 88:
                                if (g) break;
                                (a.ctrlKey || a.metaKey) && (d.last.isSafari ? d.copy(d.last.copy_event, a) : (d.last.copy_event = d.copy(!1, a), $("#grid_" + d.name + "_focus").val(d.last.copy_event.text).select(), d.copy(d.last.copy_event, a)), setTimeout(function() {
                                    d.delete(!0)
                                }, 100))
                        }
            ...
            dblClick: function(a, b) {
                var c = null;
                if ("object" == typeof a && (c = a.column, a = a.recid), null == b && (b = {}), null == c && b.target) {
                    var d = b.target;
                ...
                if ("object" == typeof c[0]) {
                    ...
                    for (var i = 0; i < g.length; i++) {
                        for (var j = g[i], k = e; k <= f; k++) {
                            ...
                            l.hidden !== !0 && (d += w2utils.stripTags(this.getCellHTML(j, k)) + "\t")
                        }
                        ...
                        if (null != j) {
                            for (var l = 0; l < h.length; l++)
                                if (this.columns[d + i]) {
                                    ...
                                    j.w2ui = j.w2ui || {}, j.w2ui.changes = j.w2ui.changes || {}, j.w2ui.changes[m] = h[l], k.push(d + i), i++
                                } for (var n = 0; n < k.length; n++) f.push({
                                recid: j.recid,
                                column: k[n]
                            });
                            c++
                    ...
                    if (d.isCancelled !== !0) {
                        ...
                        return a.markSearch && setTimeout(function() {
                            for (var b = [], c = 0; c < a.searchData.length; c++) {
                                ...
                                e && !e.hidden && b.indexOf(d.value) == -1 && b.push(d.value)
                            }
                            b.length > 0 && $(a.box).find(".w2ui-grid-data > div").w2marker(b)
            ...
            refreshBody: function() {
                ...
                if (a.length > 0) {
                    for (var b = 0; b < a.length; b++) this.summary.push(this.records[a[b]]);
                    for (var b = a.length - 1; b >= 0; b--) this.records.splice(a[b], 1)
                }
                this.scroll();
                var c = this.getRecordsHTML(),
                    d = this.getColumnsHTML(),
                    e = '<div id="grid_' + this.name + '_frecords" class="w2ui-grid-frecords" style="margin-bottom: ' + (w2utils.scrollBarSize() - 1) + 'px;">' + c[0] + '</div><div id="grid_' + this.name + '_records" class="w2ui-grid-records" onscroll="w2ui[\'' + this.name + "'].scroll(event);\">" + c[1] + '</div><div id="grid_' + this.name + '_scroll1" class="w2ui-grid-scroll1" style="height: ' + w2utils.scrollBarSize() + 'px"></div><div id="grid_' + this.name + '_fcolumns" class="w2ui-grid-fcolumns">    <table><tbody>' + d[0] + '</tbody></table></div><div id="grid_' + this.name + '_columns" class="w2ui-grid-columns">    <table><tbody>' + d[1] + "</tbody></table></div>";
                if ($("#grid_" + this.name + "_body").html(e), 0 === this.records.length && this.msgEmpty ? $("#grid_" + this.name + "_body").append('<div id="grid_' + this.name + '_empty_msg" class="w2ui-grid-empty-msg"><div>' + this.msgEmpty + "</div></div>") : $("#grid_" + this.name + "_empty_msg").length > 0 && $("#grid_" + this.name + "_empty_msg").remove(), this.summary.length > 0) {
                    var f = this.getSummaryHTML();
                    $("#grid_" + this.name + "_fsummary").html(f[0]).show(), $("#grid_" + this.name + "_summary").html(f[1]).show()
            ...
            render: function(a) {
                function b(a) {
                    if (1 == a.which && ("text" == e.last.userSelect && (delete e.last.userSelect, $(e.box).find(".w2ui-grid-body").css(w2utils.cssPrefix("user-select", "none"))), !("row" == e.selectType && ($(a.target).parents().hasClass("w2ui-head") || $(a.target).hasClass("w2ui-head")) || e.last.move && "expand" == e.last.move.type))) {
                        ...
                        else if (e.multiSelect || e.reorderRows) {
                        ...
                        $(document).on("mousemove", c), $(document).on("mouseup", d), a.stopPropagation()
                    }
                }
                    ...
                    if (setTimeout(function() {
                        ...
                        if (b && ["select", "select-column"].indexOf(b.type) != -1) {
                            if (null != b.colRange && m.isCancelled !== !0) {
                                for (var f = b.colRange.split("-"), g = [], h = 0; h < e.records.length; h++) {
                                    for (var i = [], j = parseInt(f[0]); j <= parseInt(f[1]); j++) i.push(j);
                                    g.push({
                                        recid: e.records[h].recid,
                                        column: i
                                    })
                                }
                            ...
                            if (1 == e.reorderRows && e.last.move.reorder) {
                                ...
                                if (k.isCancelled === !0) return $("#grid_" + e.name + "_ghost").remove(), void e.refresh();
                                var l = e.get(b.from, !0),
                                    n = e.get(b.to, !0),
                                    f = e.records[l];
                                null != l && null != n && (e.records.splice(l, 1), l > n ? e.records.splice(n, 0, f) : e.records.splice(n - 1, 0, f)), $("#grid_" + e.name + "_ghost").remove(), e.refresh(), e.trigger($.extend(k, {
                                    phase: "after"
                                }))
                            }
                        }
            ...
            destroy: function() {
                ...
                a.isCancelled !== !0 && ($(window).off("resize.w2ui-" + this.name), "object" == typeof this.toolbar && this.toolbar.destroy && this.toolbar.destroy(), $(this.box).find("#grid_" + this.name + "_body").length > 0 && $(this.box).removeAttr("name").removeClass("w2ui-reset w2ui-grid").html(""), delete w2ui[this.name], this.trigger($.extend(a, {
                    phase: "after"
                })))
            },
                    ...
                    j.pressed = !0, j.timeout = setTimeout(function() {
                        if (j.pressed) {
                            ...
                            if ($(a.originalEvent.target).parents().hasClass("w2ui-head")) {
                                ...
                                if (j.numberPreColumnsPresent = $(i.box).find(p).length, j.columnHead = h = $(a.originalEvent.target).parents(".w2ui-head"), k = parseInt(h.attr("col"), 10), c = i.trigger({
                                ...
                                f = j.columns = $(i.box).find(".w2ui-head:not(.w2ui-head-last)"), $(document).on("mouseup", e), $(document).on("mousemove", d), j.originalPos = parseInt($(a.originalEvent.target).parent(".w2ui-head").attr("col"), 10), j.ghost = $(b).clone(!0), $(j.ghost).find('[col]:not([col="' + j.originalPos + '"]), .w2ui-toolbar, .w2ui-grid-header').remove(), $(j.ghost).find(o).remove(), $(j.ghost).find(".w2ui-grid-body").css({
                                    top: 0
            ...
            columnOnOff: function(a, b) {
                ...
                if (d.isCancelled !== !0) {
                    for (var e = this, f = e.find({
                            "w2ui.expanded": !0
                        }, !0), g = 0; g < f.length; g++) {
                        var h = this.records[g].w2ui;
                        h && !Array.isArray(h.children) && (this.records[g].w2ui.expanded = !1)
                    }
                    if ("line-numbers" == b) this.show.lineNumbers = !this.show.lineNumbers, this.show.lineNumbers ? c.addClass("w2ui-icon-check").removeClass("w2ui-icon-empty") : c.addClass("w2ui-icon-empty").removeClass("w2ui-icon-check"), this.refreshBody(), this.resizeRecords();
                        ...
                        var i = this.getColumn(b);
                        i.hidden ? (c.addClass("w2ui-icon-check").removeClass("w2ui-icon-empty"), this.showColumn(i.field)) : (c.addClass("w2ui-icon-empty").removeClass("w2ui-icon-check"), this.hideColumn(i.field))
                    }
                    a.shiftKey || a.metaKey || a.ctrlKey || setTimeout(function() {
                        $().w2overlay({
                            name: e.name + "_toolbar"
                        })
                    }, 150), this.trigger($.extend(d, {
                        phase: "after"
                    }))
                }
            },
            ...
            initToolbar: function() {
                ...
                if (null == this.toolbar.render) {
                    ...
                    this.toolbar.on("click", function(b) {
                        function c() {
                            $("#w2ui-overlay-" + a.name + "-searchOverlay").data("keepOpen") !== !0 && (g.uncheck(e), $(document).off("click", "body", c))
                        }
                        var d = a.trigger({
                            phase: "before",
                            type: "toolbar",
                        ...
                        if (d.isCancelled !== !0) {
                            ...
                            switch (e) {
                                ...
                                case "w2ui-search-advanced":
                                    var g = this,
                                        h = this.get(e);
                                    h.checked ? (a.searchClose(), setTimeout(function() {
                                        g.uncheck(e)
                                    }, 1)) : (a.searchOpen(), b.originalEvent.stopPropagation(), $(document).on("click", "body", c));
                                    break;
                                case "w2ui-add":
                                    var d = a.trigger({
                                        phase: "before",
            ...
            resizeRecords: function() {
                ...
                if (j.length > 0) {
                    ...
                    for (var t = 0; t < this.columns.length; t++) {
                        var F = this.columns[t];
                        F.hidden || ("px" == String(F.size).substr(String(F.size).length - 2).toLowerCase() ? (B -= parseFloat(F.size), this.columns[t].sizeCalculated = F.size, this.columns[t].sizeType = "px") : (D += parseFloat(F.size), this.columns[t].sizeType = "%", delete F.sizeCorrected))
                    }
                    if (100 != D && D > 0)
                        for (var t = 0; t < this.columns.length; t++) {
                            var F = this.columns[t];
            ...
            getSearchesHTML: function() {
                ...
                for (var b = this, c = '<table cellspacing="0" onclick="event.stopPropagation()"><tbody>', d = !1, e = 0; e < this.searches.length; e++) {
                    var f = this.searches[e];
                    if (f.type = String(f.type).toLowerCase(), !f.hidden) {
                        var g = "";
                        0 == d && (g = '<button class="w2ui-btn close-btn" onclick="obj = w2ui[\'' + this.name + "']; if (obj) obj.searchClose()\">X</button>", d = !0), null == f.inTag && (f.inTag = ""), null == f.outTag && (f.outTag = ""), null == f.style && (f.style = ""), null == f.type && (f.type = "text");
                        var h = '<select id="grid_' + this.name + "_operator_" + e + '" class="w2ui-input" onclick="event.stopPropagation();"   onchange="w2ui[\'' + this.name + "'].initOperator(this, " + e + ')">' + a(f.type, f.operators) + "</select>";
                        switch (c += '<tr>    <td class="close-btn">' + g + '</td>    <td class="caption">' + (f.caption || "") + '</td>    <td class="operator">' + h + '</td>    <td class="value">', f.type) {
                            ...
                            case "datetime":
                                ...
                                break;
                            case "select":
                                c += '<select rel="search" class="w2ui-input" style="' + f.style + '" id="grid_' + this.name + "_field_" + e + '"  name="' + f.field + '" ' + f.inTag + '  onclick="event.stopPropagation();"></select>'
                        }
                        c += f.outTag + "    </td></tr>"
                    }
                }
                return c += '<tr>    <td colspan="4" class="actions">        <div>        <button class="w2ui-btn" onclick="obj = w2ui[\'' + this.name + "']; if (obj) { obj.searchReset(); }\">" + w2utils.lang("Reset") + '</button>        <button class="w2ui-btn w2ui-btn-blue" onclick="obj = w2ui[\'' + this.name + "']; if (obj) { obj.search(); }\">" + w2utils.lang("Search") + "</button>        </div>    </td></tr></tbody></table>"
            },
            ...
            initSearches: function() {
                for (var a = this, b = 0; b < this.searches.length; b++) {
                    ...
                    var f = e[0];
                    $.isPlainObject(f) && (f = f.oper), "object" != typeof c.options && (c.options = {}), "text" == c.type && (f = "begins");
            ...
            getColumnsHTML: function() {
                function a() {
                    ...
                    for (var f = 0; f < c.columnGroups.length; f++) {
                        ...
                        if (f == c.columnGroups.length - 1 && i++, i <= 0);
                            ...
                            for (var k = "", l = 0; l < c.sortData.length; l++) c.sortData[l].field == h.field && (new RegExp("asc", "i").test(c.sortData[l].direction) && (k = "w2ui-sort-up"), new RegExp("desc", "i").test(c.sortData[l].direction) && (k = "w2ui-sort-down"));
                            var m = "";
                ...
                function b(a) {
                    ...
                    for (var h = 0; h < c.columns.length; h++) {
                        var i = c.columns[h];
                        if (h == g && (e = c.columnGroups[f++] || {}, g += e.span), (!(h < c.last.colStart || h > c.last.colEnd) || i.frozen) && !i.hidden && (e.master !== !0 || a)) {
            ...
            getColumnCellHTML: function(a) {
                ...
                if (null == b) return "";
                for (var c = !this.reorderColumns || this.columnGroups && this.columnGroups.length ? "" : " w2ui-reorder-cols-head ", d = "", e = 0; e < this.sortData.length; e++) this.sortData[e].field == b.field && (new RegExp("asc", "i").test(this.sortData[e].direction) && (d = "w2ui-sort-up"), new RegExp("desc", "i").test(this.sortData[e].direction) && (d = "w2ui-sort-down"));
            ...
            getRecordsHTML: function() {
                ...
                var c = $("#grid_" + this.name + "_records"),
                    d = Math.floor(c.height() / this.recordHeight) + this.last.show_extra + 1;
                ...
                function b() {
                    c.markSearch && (clearTimeout(c.last.marker_timer), c.last.marker_timer = setTimeout(function() {
                        for (var a = [], b = 0; b < c.searchData.length; b++) {
                            ...
                            e && !e.hidden && a.indexOf(d.value) == -1 && a.push(d.value)
                        }
                        a.length > 0 && $(c.box).find(".w2ui-grid-data > div").w2marker(a)
                    }, 50))
                }
            ...
            getRecordHTML: function(a, b, c) {
                ...
                for (var p = 0, q = 0;;) {
                    ...
                    if (j.hidden) p++, q > 0 && q--;
                        ...
                        if (p++, null == this.columns[p]) break;
                        d.w2ui.colspan[this.columns[p - 1].field] = 0, q--
                    } else {
                        if (d.w2ui) {
                            var s = d.w2ui.colspan,
                                t = this.columns[p].field;
                            s && 0 === s[t] && delete s[t]
                        }
                        if (!(p < this.last.colStart || p > this.last.colEnd) || j.frozen) {
                            if (d.w2ui && "object" == typeof d.w2ui.colspan) {
                                var u = parseInt(d.w2ui.colspan[j.field]) || null;
                                if (u > 1) {
                                    for (var v = 0, i = p; i < p + u && !(i >= this.columns.length); i++) this.columns[i].hidden && v++;
                                    r = u - v, q = u - 1
                                }
                            }
                            var w = this.getCellHTML(a, p, c, r);
                            j.frozen ? f += w : g += w, p++
                        } else p++
                    }
                }
            ...
            getCellHTML: function(a, b, c, d) {
                ...
                var f = c !== !0 ? this.records[a] : this.summary[a],
                    g = this.getCellValue(a, b, c),
                    h = this.getCellEditable(a, b),
                ...
                if (e.info === !0 && (e.info = {}), null != e.info && (e.info.icon || (e.info.icon = "w2ui-icon-info"), o += '<span class="w2ui-info ' + e.info.icon + '" style="' + (e.info.style || "") + '"  onclick="event.stopPropagation(); w2ui[\'' + this.name + "'].showBubble(" + a + ", " + b + ')"></span>'), null != e.render) {
                    if ("function" == typeof e.render && (g = $.trim(e.render.call(this, f, a, b, g)), (g.length < 4 || "<div" != g.substr(0, 4).toLowerCase()) && (g = '<div style="' + i + '">' + o + String(g) + "</div>")), "object" == typeof e.render && (g = '<div style="' + i + '">' + o + (e.render[g] || "") + "</div>"), "string" == typeof e.render) {
                        var t = e.render.toLowerCase().indexOf(":"),
                            r = [];
                        t == -1 ? (r[0] = e.render.toLowerCase(), r[1] = "") : (r[0] = e.render.toLowerCase().substr(0, t), r[1] = e.render.toLowerCase().substr(t + 1));
                        var u = w2utils.formatters[r[0]];
                        g = '<div style="' + i + '">' + o + ("function" == typeof u ? u(g, r[1]) : "") + "</div>"
                    }
                } else {
                    if (h && ["checkbox", "check"].indexOf(h.type) != -1) {
                        var v = c ? -(a + 1) : a;
                        i += "text-align: center;", g = '<input tabindex="-1" type="checkbox" ' + (g ? 'checked="checked"' : "") + " onclick=\"    var obj = w2ui['" + this.name + "'];     obj.editChange.call(obj, this, " + v + ", " + b + ', event); "/>', o = ""
                    }
                    if (this.show.recordTitles) {
                        var w = w2utils.stripTags(String(g).replace(/"/g, "''"));
                        null != e.title && ("function" == typeof e.title && (w = e.title.call(this, f, a, b)), "string" == typeof e.title && (w = e.title))
                    }
                    g = '<div style="' + i + '" title="' + (w || "") + '">' + o + String(g) + "</div>"
                }
                ...
                var x = !1;
                return n && $.inArray(b, m.columns[a]) != -1 && (x = !0), g = '<td class="w2ui-grid-data' + (x ? " w2ui-selected" : "") + " " + l + (j ? " w2ui-changed" : "") + '"    id="grid_' + this.name + "_data_" + a + "_" + b + '" col="' + b + '"    style="' + k + (null != e.style ? e.style : "") + '" ' + (null != e.attr ? e.attr : "") + (d > 1 ? 'colspan="' + d + '"' : "") + ">" + g + "</td>"
            },
            ...
            getCellValue: function(a, b, c) {
                ...
                return e && e.w2ui && e.w2ui.changes && null != e.w2ui.changes[d.field] && (f = e.w2ui.changes[d.field]), $.isPlainObject(f) && d.editable && (null != f.text && (f = f.text), null != f.id && (f = f.id)), null == f && (f = ""), f
            },
            ...
            stateSave: function(a) {
                ...
                for (var b = {
                    ...
                    b.columns.push({
                        ...
                        sizeCalculated: d.sizeCalculated ? d.sizeCalculated : null,
                        sizeOriginal: d.sizeOriginal ? d.sizeOriginal : null,
                        sizeType: d.sizeType ? d.sizeType : null
                    })
                }
                for (var c = 0; c < this.sortData.length; c++) b.sortData.push($.extend({}, this.sortData[c]));
                for (var c = 0; c < this.searchData.length; c++) b.searchData.push($.extend({}, this.searchData[c]));
                if (a !== !0) {
                    var e = this.trigger({
                        phase: "before",
                        type: "stateSave",
                    ...
                    try {
                        ...
                        f || (f = {}), f.states || (f.states = {}), f.states[this.stateId || this.name] = b, localStorage.w2ui = JSON.stringify(f)
                    } catch (a) {
    ...
    function(a) {
        ...
        a.fn.w2layout = function(d) {
            ...
            assignToolbar: function(b, c) {
                ...
                null != d.toolbar ? (0 === e.find("[name=" + d.toolbar.name + "]").length ? e.w2render(d.toolbar) : null != d.toolbar && d.toolbar.refresh(), this.showToolbar(b), this.refresh("main")) : (e.html(""), this.hideToolbar(b))
            },
            hideTabs: function(b) {
                var c = this.get(b);
            ...
            resize: function() {
                ...
                if (e.isCancelled !== !0) {
                    ...
                    "-" == String(q.size).substr(0, 1) && (u && "-" == p.size.substr(0, 1) ? console.log("ERROR: you cannot have both left panel.size and right panel.size be negative.") : q.sizeCalculated = f - (u ? p.sizeCalculated : 0) + parseInt(q.size)), "-" == String(p.size).substr(0, 1) && (v && "-" == q.size.substr(0, 1) ? console.log("ERROR: you cannot have both left panel.size and right panel.size be negative.") : p.sizeCalculated = f - (v ? q.sizeCalculated : 0) + parseInt(p.size)), null != r && r.hidden !== !0 ? (h = 0, i = 0, j = f, k = r.sizeCalculated, a("#layout_" + this.name + "_panel_top").css({
                        ...
                        width: j + "px",
                        height: k + "px"
                    }).show(), o.width = j, o.height = k, o.resizable && (i -= 0 === this.padding ? 0 : this.padding, k = this.resizer > this.padding ? this.resizer : this.padding, a("#layout_" + this.name + "_resizer_preview").show().css({
                        display: "block",
                        left: h + "px",
                        top: i + "px",
                        width: j + "px",
...
! function(a) {
    a.fn.w2popup = function(b, c) {
        ...
        if (a(this).length > 0 && "open" == b) {
            ...
            0 !== parseInt(a(this).css("width")) && (d.width = parseInt(a(this).css("width"))), 0 !== parseInt(a(this).css("height")) && (d.height = parseInt(a(this).css("height")))
        }
        ...
        load: function(b) {
            function c(c, d) {
                if (delete b.url, a("body").append('<div id="w2ui-tmp" style="display: none">' + c + "</div>"), null != d && a("#w2ui-tmp #" + d).length > 0 ? a("#w2ui-tmp #" + d).w2popup(b) : a("#w2ui-tmp > div").w2popup(b), a("#w2ui-tmp > style").length > 0) {
                    ...
                    0 === a("#w2ui-popup #div-style").length && a("#w2ui-popup").append('<div id="div-style" style="position: absolute; left: -100; width: 1px"></div>'),
                        a("#w2ui-popup #div-style").html(e)
                }
                a("#w2ui-tmp").remove()
            }
...
var w2alert = function(a, b, c) {
        ...
        return 1 == arguments.length && "object" == typeof a ? d.extend(e, f, a) : "function" == typeof b ? d.extend(e, f, {
            ...
            onOpen: function(a) {
                setTimeout(function() {
                    ...
                    }), d("#w2ui-popup .w2ui-popup-btn#Yes").focus()
                }, 1)
            },
            onKeydown: function(a) {
    ...
    w2prompt = function(a, b, c) {
        ...
        return 1 == arguments.length && "object" == typeof a ? d.extend(e, f, a) : "function" == typeof b ? d.extend(e, f, {
            ...
            width: e.width,
            height: e.height,
            body: '<div class="w2ui-centered" style="font-size: 13px;">   <label style="margin-right: 10px;">' + e.label + ':</label>   <input id="w2prompt" ' + e.attrs + "></div>",
            ...
            modal: !0,
            showClose: !1,
            body: '<div class="w2ui-centered" style="font-size: 13px;"><label style="margin-right: 10px;">' + e.label + ':</label><input id="w2prompt"></div>',
            buttons: '<button id="Ok" class="w2ui-popup-btn w2ui-btn">' + e.ok_text + '</button><button id="Cancel" class="w2ui-popup-btn w2ui-btn">' + e.cancel_text + "</button>",
            onOpen: function(a) {
                setTimeout(function() {
    ...
    a.fn.w2toolbar = function(c) {
        ...
        click: function(b, c) {
            ...
            if (f && !f.disabled) {
                ...
                if (["menu", "menu-radio", "menu-check", "drop", "color", "text-color"].indexOf(f.type) != -1 && (d.tooltipHide(b), f.checked ? setTimeout(function() {
                        ...
                        var e = a("#tb_" + d.name + "_item_" + w2utils.escapeId(f.id));
                        a.isPlainObject(f.overlay) || (f.overlay = {});
                        var g = (e.width() - 50) / 2;
                        if (g > 19 && (g = 19), "drop" == f.type && e.w2overlay(f.html, a.extend({
                                name: d.name,
                                left: g,
                                top: 3
                            }, f.overlay, {
                            ...
                            var h = "normal";
                            "menu-radio" == f.type && (h = "radio", f.items.forEach(function(a) {
                                f.selected == a.id ? a.checked = !0 : a.checked = !1
                            })), "menu-check" == f.type && (h = "check", f.items.forEach(function(b) {
                        ...
                        } ["color", "text-color"].indexOf(f.type) != -1 && (null == f.transparent && (f.transparent = !0),
                            a(e).w2color({
                                color: f.color,
        ...
        getItemHTML: function(a) {
            ...
            if ("function" == typeof d && (d = d.call(this, a)), a.img && (c = '<td><div class="w2ui-tb-image w2ui-icon ' + a.img + '"></div></td>'), a.icon && (c = '<td><div class="w2ui-tb-image"><span class="' + a.icon + '"></span></div></td>'), "" === b) switch (a.type) {
                case "color":
                case "text-color":
                    "string" == typeof a.color && "#" == a.color.substr(0, 1) && (a.color = a.color.substr(1)), "color" == a.type && (d = '<div style="height: 12px; width: 12px; margin-top: 1px; border: 1px solid #8A8A8A; border-radius: 1px; box-shadow: 0px 0px 1px #fff;         background-color: #' + (null != a.color ? a.color : "fff") + '; float: left;"></div>' + (a.text ? '<div style="margin-left: 17px;">' + w2utils.lang(a.text) + "</div>" : "")), "text-color" == a.type && (d = '<div style="color: #' + (null != a.color ? a.color : "444") + ';">' + (a.text ? w2utils.lang(a.text) : "<b>Aa</b>") + "</div>");
                case "menu":
                case "menu-check":
                case "menu-radio":
                case "button":
        ...
        tooltipShow: function(b, c, d) {
            if (null != this.tooltip) {
                var e = a(this.box).find("#tb_" + this.name + "_item_" + w2utils.escapeId(b)),
                    ...
                    h = f.tooltip;
                "function" == typeof h && (h = h.call(this, f)), e.prop("_mouse_over", !0), setTimeout(function() {
                    if (e.prop("_mouse_over") === !0 && e.prop("_mouse_tooltip") !== !0) {
        ...
        tooltipHide: function(b, c) {
            if (null != this.tooltip) {
                ...
                this.get(b);
                d.removeProp("_mouse_over"), setTimeout(function() {
                    d.prop("_mouse_over") !== !0 && d.prop("_mouse_tooltip") === !0 && (d.removeProp("_mouse_tooltip"), d.w2tag())
                }, 1)
            }
        },
        menuClick: function(b) {
            ...
            if (b.item && !b.item.disabled) {
                ...
                if ("menu-radio" == f.type && (f.selected = e.id, b.item.items.forEach(function(a) {
                    ...
                    a.isArray(f.selected) || (f.selected = []);
                ...
                if ("string" == typeof e.route) {
                    var h = "" !== e.route ? String("/" + e.route).replace(/\/{2,}/g, "/") : "",
                        i = w2utils.parseRoute(h);
                    if (i.keys.length > 0)
                        for (var j = 0; j < i.keys.length; j++) null != c.routeData[i.keys[j].name] && (h = h.replace(new RegExp(":" + i.keys[j].name, "g"), this.routeData[i.keys[j].name]));
                    setTimeout(function() {
    ...
    a.fn.w2sidebar = function(c) {
        ...
        refresh: function(b) {
            ...
            if (e.isCancelled !== !0) {
                ...
                var g, h, i, j = this;
                if (null == b) g = this, i = ".w2ui-sidebar-div";
                else {
                    if (g = this.get(b), null == g) return;
                    i = "#node_" + w2utils.escapeId(g.id) + "_sub"
                }
                var k;
                if (g !== this) {
                    var l = "#node_" + w2utils.escapeId(g.id);
                    k = c(g), a(this.box).find(l).before('<div id="sidebar_' + this.name + '_tmp"></div>'), a(this.box).find(l).remove(), a(this.box).find(i).remove(), a("#sidebar_" + this.name + "_tmp").before(k), a("#sidebar_" + this.name + "_tmp").remove()
                }
                a(this.box).find(i).html("");
                for (var m = 0; m < g.nodes.length; m++)
                    if (h = g.nodes[m], k = c(h), a(this.box).find(i).append(k), 0 !== h.nodes.length) this.refresh(h.id);
                    else {
                        var n = this.trigger({
                            phase: "before",
                            type: "refresh",
...
function(a) {
    ...
    a.fn.w2field = function(c, d) {
            ...
            switch (this.type) {
                ...
                case "hex":
                    b = {
                        ...
                        prefix: "",
                        suffix: ""
                    }, this.options = a.extend(!0, {}, b, d), d = this.options, d.numberRE = new RegExp("[" + d.groupSymbol + "]", "g"), d.moneyRE = new RegExp("[" + d.currencyPrefix + d.currencySuffix + d.groupSymbol + "]", "g"), d.percentRE = new RegExp("[" + d.groupSymbol + "%]", "g"), ["text", "alphanumeric", "hex", "bin"].indexOf(this.type) != -1 && (d.arrows = !1,
                        d.keyboard = !1), this.addPrefix(), this.addSuffix();
                    break;
                case "color":
                    b = {
                        prefix: "#",
                ...
                case "combo":
                    ...
                    d = a.extend({}, b, d, {
                        align: "both",
                        altRows: !0
                    }), this.options = d, a.isPlainObject(d.selected) || (d.selected = {}), a(this.el).data("selected", d.selected), d.url && (d.items = [], this.request(0)), "list" == this.type && this.addFocus(), this.addPrefix(), this.addSuffix(), setTimeout(function() {
                        c.refresh()
                ...
                case "file":
                    b = {
                        ...
                        align: "both",
                        altRows: !0
                    }), this.options = d, a.isArray(d.selected) || (d.selected = []), a(this.el).data("selected", d.selected), null == a(this.el).attr("placeholder") && a(this.el).attr("placeholder", w2utils.lang("Attach files by dragging and dropping or Click to Select")), this.addMulti(), this.watchSize()
            }
            this.tmp = {
                onChange: function(a) {
                    c.change.call(c, a)
        ...
        clear: function() {
            var b = this.options;
            ["money", "currency"].indexOf(this.type) != -1 && a(this.el).val(a(this.el).val().replace(b.moneyRE, "")), "percent" == this.type && a(this.el).val(a(this.el).val().replace(/%/g, "")), "color" == this.type && a(this.el).removeAttr("maxlength"), "list" == this.type && a(this.el).removeClass("w2ui-select"), this.type = "clear";
        ...
        blur: function(b) {
            var c = this,
                d = c.options,
                e = a(c.el).val().trim();
            ["color", "date", "time", "list", "combo", "enum", "datetime"].indexOf(c.type) != -1 && a("#w2ui-overlay").length > 0 && a("#w2ui-overlay")[0].hide(), ["int", "float", "money", "currency", "percent"].indexOf(c.type) != -1 && ("" === e || c.checkType(e) || (a(c.el).val("").change(), d.silent === !1 && (a(c.el).w2tag("Not a valid number"), setTimeout(function() {
                a(c.el).w2tag("")
        ...
        keyUp: function(b) {
            var c = this;
            if ("color" == this.type && 86 == b.keyCode && (b.ctrlKey || b.metaKey) && a(this).prop("maxlength", 6), ["list", "combo", "enum"].indexOf(this.type) != -1) {
                if (a(c.el).prop("readonly") || a(c.el).prop("disabled")) return;
                ...
                null == b && (b = d.interval), null == c.tmp.xhr_search && (c.tmp.xhr_search = ""), null == c.tmp.xhr_total && (c.tmp.xhr_total = -1), d.url && a(c.el).prop("readonly") !== !0 && a(c.el).prop("disabled") !== !0 && (0 === d.items.length && 0 !== c.tmp.xhr_total || c.tmp.xhr_total == d.cacheMax && e.length > c.tmp.xhr_search.length || e.length >= c.tmp.xhr_search.length && e.substr(0, c.tmp.xhr_search.length) != c.tmp.xhr_search || e.length < c.tmp.xhr_search.length) && (c.tmp.xhr && c.tmp.xhr.abort(), c.tmp.xhr_loading = !0, c.search(), clearTimeout(c.tmp.timeout), c.tmp.timeout = setTimeout(function() {
                    ...
                    if (g.isCancelled !== !0) {
                        ...
                        d.method && (h.type = d.method), "JSON" == w2utils.settings.dataType && (h.type = "POST", h.data = JSON.stringify(h.data), h.contentType = "application/json"), "HTTPJSON" == w2utils.settings.dataType && (h.data = {
                            ...
                            if (i.isCancelled !== !0) {
                                if (b = i.data, "string" == typeof b && (b = JSON.parse(b)), null == b.records && null != b.items && (b.records = b.items, delete b.items), "success" != b.status || !Array.isArray(b.records)) return void console.log("ERROR: server did not return proper structure. It should return", {
                                    status: "success",
                                    records: [{
                                        id: 1,
                                        text: "item"
        ...
        updateOverlay: function(b) {
            ...
            if ("date" == this.type) {
                if (a(c.el).prop("readonly") || a(c.el).prop("disabled")) return;
                0 === a("#w2ui-overlay").length && a(c.el).w2overlay('<div class="w2ui-reset w2ui-calendar" onclick="event.stopPropagation();"></div>', {
                    css: {
        ...
        addMulti: function() {
            ...
            "file" == b.type && (c = '<div class="w2ui-field-helper w2ui-list" style="' + d + '; box-sizing: border-box">   <div style="position: absolute; left: 0px; right: 0px; top: 0px; bottom: 0px;">       <input class="file-input" type="file" style="width: 100%; height: 100%; opacity: 0;" name="attachment" multiple tabindex="-1"' + (a(b.el).prop("readonly") ? ' readonly="readonly"' : "") + (a(b.el).prop("disabled") ? ' disabled="disabled"' : "") + (a(b.el).attr("accept") ? ' accept="' + a(b.el).attr("accept") + '"' : "") + '/>   </div>    <div style="position: absolute; padding: 0px; margin: 0px; display: inline-block" class="w2ui-multi-items">        <ul><li style="padding-left: 0px; padding-right: 0px" class="nomouse"></li></ul>    </div></div>');
        ...
        addFile: function(b) {
            ...
            if (k.isCancelled !== !0) {
                ...
                if (0 !== e.maxSize && h + g.size > e.maxSize) return c = "Maximum total size is " + w2utils.formatSize(e.maxSize), e.silent === !1 && a(d.el).w2tag(c), void console.log("ERROR: " + c);
...
function($) {
    var w2form = function(a) {
        this.name = null, this.header = "", this.box = null, this.url = "", this.routeData = {}, this.formURL = "", this.formHTML = "", this.page = 0, this.recid = 0, this.fields = [], this.actions = {}, this.record = {}, this.original = {}, this.postData = {}, this.httpHeaders = {}, this.method = null, this.toolbar = {}, this.tabs = {}, this.style = "", this.focus = 0, this.isGenerated = !1, this.last = {
            xhr: null
    ...
    $.fn.w2form = function(a) {
            ...
            if (f.isCancelled !== !0) {
                if (a)
                    for (var g = 0; g < f.errors.length; g++) {
                        var h = f.errors[g];
                        null != h.field && ("radio" == h.field.type ? $($(h.field.el).parents("div")[0]).w2tag(h.error, {
                            class: "w2ui-error"
                        }) : ["enum", "file"].indexOf(h.field.type) != -1 ? ! function(a) {
                            setTimeout(function() {
        ...
        save: function(postData, callBack) {
            ...
            if (0 === errors.length) {
                ...
                obj.lock(w2utils.lang(obj.msgSaving) + ' <span id="' + obj.name + '_progress"></span>'), setTimeout(function() {
                    var params = {};
                    params.cmd = "save", params.recid = obj.recid, params.name = obj.name, $.extend(params, obj.postData), $.extend(params, postData), obj.fields.forEach(function(a) {
        ...
        generateHTML: function() {
            for (var a, b, c, d = [], e = "", f = 0; f < this.fields.length; f++) {
                c = "";
                var g = this.fields[f];
                null == g.html && (g.html = {}), null == g.options && (g.options = {}), g.html = $.extend(!0, {
                    caption: "",
                    span: 6,
                    attr: "",
                    text: "",
                    ...
                    page: 0,
                    column: 0
                }, g.html), null == a && (a = g.html.page), null == b && (b = g.html.column), "" === g.html.caption && (g.html.caption = g.name);
                var h = '<input name="' + g.name + '" class="w2ui-input" type="text" ' + g.html.attr + ' tabindex="' + (f + 1) + '"/>';
                switch (g.type) {
                    case "pass":
                    case "password":
                        h = '<input name="' + g.name + '" class="w2ui-input" type = "password" ' + g.html.attr + ' tabindex="' + (f + 1) + '"/>';
                        break;
                    case "checkbox":
                        h = '<input name="' + g.name + '" class="w2ui-input" type="checkbox" ' + g.html.attr + ' tabindex="' + (f + 1) + '"/>';
                        break;
                    case "radio":
                        h = "";
                        var i = g.options.items ? g.options.items : g.html.items;
                        $.isArray(i) || (i = []), i.length > 0 && (i = w2obj.field.prototype.normMenu(i));
                        for (var j = 0; j < i.length; j++) h += '<label><input name="' + g.name + '" class="w2ui-input" type = "radio" ' + g.html.attr + ' value="' + i[j].id + '"/>&#160;' + i[j].text + "</label><br/>";
                        break;
                    case "select":
                        h = '<select name="' + g.name + '" class="w2ui-input" ' + g.html.attr + ' tabindex="' + (f + 1) + '">';
                        var i = g.options.items ? g.options.items : g.html.items;
                        $.isArray(i) || (i = []), i.length > 0 && (i = w2obj.field.prototype.normMenu(i));
                        for (var j = 0; j < i.length; j++) h += '<option value="' + i[j].id + '">' + i[j].text + "</option>";
                        h += "</select>";
                        break;
                    case "textarea":
                        h = '<textarea name="' + g.name + '" class="w2ui-input" ' + g.html.attr + ' tabindex="' + (f + 1) + '"></textarea>';
                        break;
                    case "toggle":
                        h = '<input name="' + g.name + '" type="checkbox" ' + g.html.attr + ' class="w2ui-input w2ui-toggle" tabindex="' + (f + 1) + '"/><div><div></div></div>';
                        break;
                    case "html":
                    case "custom":
                    case "empty":
                ...
                "" !== e && (a != g.html.page || b != g.html.column || g.html.group && e != g.html.group) && (d[a][b] += "\n   </div>", e = ""), g.html.group && e != g.html.group && (c += '\n   <div class="w2ui-group-title">' + g.html.group + '</div>\n   <div class="w2ui-group">', e = g.html.group), c += '\n      <div class="w2ui-field ' + (null != g.html.span ? "w2ui-span" + g.html.span : "") + '" style="' + g.html.style + '">\n         <label>' + w2utils.lang(g.html.caption) + "</label>\n         <div>" + h + w2utils.lang(g.html.text) + "</div>\n      </div>", null == d[g.html.page] && (d[g.html.page] = []), null == d[g.html.page][g.html.column] && (d[g.html.page][g.html.column] = ""), d[g.html.page][g.html.column] += c, a = g.html.page, b = g.html.column
            }
            if ("" !== e && (d[a][b] += "\n   </div>"), this.tabs.tabs)
                for (var j = 0; j < this.tabs.tabs.length; j++) null == d[j] && (d[j] = []);
            var k = "";
            if (!$.isEmptyObject(this.actions)) {
                k += '\n<div class="w2ui-buttons">';
                for (var l in this.actions) {
                    var m = this.actions[l],
                        n = {
                            caption: "",
                            style: "",
                            class: ""
                        };
                    $.isPlainObject(m) ? (m.caption && (n.caption = m.caption), m.style && (n.style = m.style), m.class && (n.class = m.class)) : (n.caption = l, ["save", "update", "create"].indexOf(l.toLowerCase()) != -1 ? n.class = "w2ui-btn-blue" : n.class = ""), k += '\n    <button name="' + l + '" class="w2ui-btn ' + n.class + '" style="' + n.style + '">' + w2utils.lang(n.caption) + "</button>"
                }
                k += "\n</div>"
            }
            c = "";
            for (var o = 0; o < d.length; o++) {
                c += '<div class="w2ui-page page-' + o + '" ' + (0 === o ? "" : 'style="display: none;"') + '><div class="w2ui-column-container" style="display: flex;">';
                for (var p = 0; p < d[o].length; p++) c += '<div class="w2ui-column col-' + p + '">' + (d[o][p] || "") + "\n</div>";
                c += "\n</div></div>"
            }
            return c += k
        },
        ...
        refresh: function(a) {
            ...
            if (this.box && this.isGenerated && null != $(this.box).html()) {
                ...
                if (d.isCancelled !== !0) {
                    ...
                    for (var g = e; g < f; g++) {
                        var a = this.fields[g];
                        null == a.name && null != a.field && (a.name = a.field), null == a.field && null != a.name && (a.field = a.name), a.$el = $(this.box).find('[name="' + String(a.name).replace(/\\/g, "\\\\") + '"]'), a.el = a.$el[0], null == a.el && console.log('ERROR: Cannot associate field "' + a.name + '" with html control. Make sure html control exists with the same name.'), a.el && (a.el.id = a.name);
                        ...
                        }), a.required ? $(a.el).parent().parent().addClass("w2ui-required") : $(a.el).parent().parent().removeClass("w2ui-required"), null != a.disabled && (a.disabled ? $(a.el).prop("readonly", !0) : $(a.el).prop("readonly", !1)), a.hidden ? $(a.el).parent().parent().hide() : $(a.el).parent().parent().show()
                    }
